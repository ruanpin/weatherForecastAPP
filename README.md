...
**Tech Stack:**  
React + JavaScript + Vite ，並整合 Redux + RTK query、Tailwind CSS、React-router-dom、Lucide、Jest、Git、Vercel  
...
**4.使用者體驗(UX)增加**  
資料請求期間顯示 Loading 轉圈動畫

**5.儲存常用城市（收藏城市功能）:**  
在城市當前天氣狀況區塊中，右下愛心**只會在「已搜尋出城市後且城市名不等於City Not Found」時出現**，右下愛心按鈕為「加入/移除」常用城市清單，紅色愛心為已經加入，空心則為尚未加入收藏; 右上按鈕為點選開啟常用城市清單，並可進行「查看常用城市清單」、「快速選擇城市」、「移除」等功能  
